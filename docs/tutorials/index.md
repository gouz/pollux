...
Get started with Pollux by following these step-by-step lessons.

| Tutorial | What you'll learn |
|---|---|
| [Getting started](getting-started.md) | Set up Pollux and create your first poll in 5 minutes |
